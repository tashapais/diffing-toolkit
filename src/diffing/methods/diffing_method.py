...
class DiffingMethod(ABC):
    ...
    def base_model(self) -> AutoModelForCausalLM:
        ...
        if self._base_model is None:
            self._base_model, self._tokenizer = load_model_from_config(self.base_model_cfg)
    ...
    def generate_text(self, prompt: str, model_type: str = "base", max_length: int = 50, temperature: float = 0.7, do_sample: bool = True) -> str:
        """
