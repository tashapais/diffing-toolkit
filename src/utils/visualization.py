...
import sys
import json
from tiny_dashboard.html_utils import create_example_html, create_base_html, create_highlighted_tokens_html
...
def statistic_interactive_tab(statistics_function: Callable, interactive_function: Callable, title: str):
    """
